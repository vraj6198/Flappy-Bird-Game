...
def welcomeScreen(QUIT=None, KEYDOWN=None, K_ESCAPE=None, K_SPACE=None, K_UP=None):
    """
...
def mainGame(QUIT=None, KEYDOWN=None, K_ESCAPE=None, K_UP=None, K_SPACE=None):
    score = 0
    playerx = int(SCREENWIDTH / 5)
...
if __name__ == "__main__":
    ...
    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('gallery/audio/Crash.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('gallery/audio/Push.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('gallery/audio/Throw.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('gallery/audio/Trap.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('gallery/audio/toy.wav')
